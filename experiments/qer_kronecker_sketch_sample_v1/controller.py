...
def main():
    ...
    require(config['profile']=='dual4090' and config['modules']==[PLAN['module']],'Only registered L31 dual4090 allowed')
    ...
    for field in ('assets','model','wikitext','geometry_history'):
    ...
    with lock(root):
        ...
        try:
            ...
            if not hp.exists():
                require(hw['free_disk_GiB']>=PLAN['minimum_free_GiB'],'Need at least 128 GiB free disk before pilot')
