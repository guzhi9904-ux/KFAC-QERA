...
PLAN=dict(layers=LAYERS,windows=WINDOWS,pilot_windows=[0,32],layer_order=[20,0,10,31],
          ...
          centered_formula_check='Same native P/delta/V converted to FP64: centered vs direct at1e-10; native edge/dp/z vs FP64 at1e-5',
          native_FP32_reassociation='Report separately; do not equate distinct forward/backward GEMM rounding paths',
...
def identity(kroot,vroot):
    ...
    material=dict(version='k_structure_audit_v3',plan=PLAN,ko_run=str(kroot),v_run=str(vroot),
