...
def validate(config):
    require(config['modules']==MODULES and config['methods']==METHODS,'This version registers exactly12 modules and Marginal/Token-joint/Sequence-one-step; Full-fit excluded')
